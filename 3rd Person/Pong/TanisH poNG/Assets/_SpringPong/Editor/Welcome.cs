...
namespace AppAdvisory.SpringPong
{
	...
	public class Welcome : EditorWindow 
	{
		...
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://dl.dropboxusercontent.com/u/8289407/PinkPong/Documentation/_DOC.pdf";
		private const string RATEUS_URL = "http://u3d.as/pja";

		private const string NAME_OF_THE_GAME = "SPRING PONG";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
